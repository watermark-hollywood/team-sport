$(document).ready(function(){
    ...
    $(window).scroll(function(){
        ...
        if (currentScrollTop > lastScrollTop && currentScrollTop >= 0) {
            $header.addClass('header--parked');
        } else if (currentScrollTop + $(window).height() < $(document).height() && currentScrollTop == 0) {
            $header.removeClass('header--parked');
        }
    ...
    // process the form
    $('beta-registration-form').submit(function(event) {
        ...
        $.ajax({
            ...
            .done(function(data) {
				...
				if ( ! data.success) {
					...
					$('#messageDiv').append('<div class="panel panel-success><div class="panel-body">' + data.message + '</div></div>');
...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        pageTransition: function() {
            ...
            if (!e().animsition) return a.addClass("no-transition"), console.log("pageTransition: Animation not Defined."), !0;
