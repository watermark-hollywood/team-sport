...
// ---------------------------------------------------------------------------------
//  FILENAME:      update-category-minimum-order.php
//
//  DESCRIPTION:   Update Category Name 
//
//  NOTES:         This source script is used to update minimum orders
//
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$category_minimum_order = 	filter_var(trim($_POST["category_minimum_order"]), FILTER_SANITIZE_STRING);

	if($_POST["category_id"]){
		// --------------------------------------------------------------------------  
		// Look the domain up in the database.
		// --------------------------------------------------------------------------  
		$query = "UPDATE product_categories SET category_minimum_order = '$category_minimum_order' WHERE id = '$category_id';"; 
