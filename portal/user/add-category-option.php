...
// ---------------------------------------------------------------------------------
//  FILENAME:      add-category-option.php
//
//  DESCRIPTION:   Add a new option for a category 
//
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if($_POST["category_id"]){
		...
		// --------------------------------------------------------------------------  
		$query = "INSERT INTO category_options (category_id, option_name, option_file, option_vdp) VALUES ('$category_id', '$option_name', $option_file, $option_vdp);"; 
