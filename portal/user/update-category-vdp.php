...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$category_vdp = 	filter_var(trim($_POST["category_vdp"]), FILTER_SANITIZE_STRING);

	if($_POST["category_id"]){
		// --------------------------------------------------------------------------  
		// Look the domain up in the database.
		// --------------------------------------------------------------------------  
		$query = "UPDATE product_categories SET category_vdp = '$category_vdp' WHERE id = '$category_id';"; 
