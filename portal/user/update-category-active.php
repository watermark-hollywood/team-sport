...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$category_active = 	filter_var(trim($_POST["category_active"]), FILTER_SANITIZE_STRING);

	if($_POST["category_id"]){
		// --------------------------------------------------------------------------  
		// Look the domain up in the database.
		// --------------------------------------------------------------------------  
		$query = "UPDATE product_categories SET category_active = '$category_active' WHERE id = '$category_id';"; 
