...
// ---------------------------------------------------------------------------------
//  FILENAME:      update-product-featured.php
//
//  DESCRIPTION:   Update Product Featured 
//
//  NOTES:         This source script is used to update product featured status
//
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if($_POST["product_id"]){
		...
		// --------------------------------------------------------------------------  
		$query = "UPDATE products SET featured = '$featured' WHERE id = $product_id;"; 
