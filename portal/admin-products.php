...
<body>
	...
	<div class="container" id="body-container">
        <div class="row">
            ...
            <div class="col-sm-9">
                <!-- Tab panes -->
                <div class="config-right tab-content">
                  <div class="tab-pane active" id="categories" role="tabpanel">Categories</div>
                  <div class="tab-pane" id="products" role="tabpanel">Products</div>
                  <div class="tab-pane" id="promotions" role="tabpanel">Promotions</div>
                </div>
            </div>
        </div>
	</div>
